...
const HeroSection = () => {
  ...
  return (
    <section className="pattern-bg relative">
      {/* Background pattern only - no mosque image in mobile landscape */}
      <div 
        className="absolute inset-0 bg-cover bg-center opacity-30 z-0 brightness-110 contrast-125 saturate-175 hidden md:block" 
        style={{
